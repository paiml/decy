...
637 uncovered lines remain workspace-wide at 98.26% line coverage (98.02% region). Classification:
...
| Deep codegen integration paths | ~108 | 17.0% | Dead code, macro expansion artifacts, full pipeline paths |
